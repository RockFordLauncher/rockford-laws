...
📌 Статьи: ОБЯЗАТЕЛЬНО пиши ссылки на статьи в формате [кодекс-айди] (например, [uk-1.1] или [pk-a-3.5]). Рядом с каждой статьей ОБЯЗАТЕЛЬНО кратко объясни, КАК ИМЕННО эта статья относится к описанной ситуации, а не просто пиши её название.
