...
📌 Статьи: ОБЯЗАТЕЛЬНО пиши ссылки на статьи. В скобках используй ТОЛЬКО точное значение поля "id" из JSON (например, [uk-a-123] или [pk-c-5]). НЕ ПРИДУМЫВАЙ ID сам! Рядом с каждой ссылкой кратко объясни, КАК ИМЕННО эта статья относится к ситуации.
